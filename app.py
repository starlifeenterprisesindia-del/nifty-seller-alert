...
option_chain = {"success": False, "message": "Dhan option chain not enabled."}
...
st.markdown("---")
st.markdown(
    "<div class='small-note'>Disclaimer: Decision-support only. OI/price labels are probabilistic inferences, not proof of buyer/seller identity. Use hedges, live chart confirmation, liquidity checks and strict risk limits.</div>",
    unsafe_allow_html=True,
)
