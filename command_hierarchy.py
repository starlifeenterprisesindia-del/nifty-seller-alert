...
OBSERVATION_ONLY_BRANCHES = {"MARKET_PSYCHOLOGY", "MARKET_JOURNEY", "TIME_INTELLIGENCE", "HEAVYWEIGHT_INTELLIGENCE", "NEWS_INTELLIGENCE", "EXPERIENCE", "SELF_REVIEW", "PROMOTION_BOARD"}
...
class CommandingOfficer:
    ...
    def prepare_case_file(self, *, snapshot_id: str, data_quality_score: float, branches: Iterable[BranchReport]) -> COCaseFile:
        ...
        accepted_evidence: List[str] = []
        rejected_evidence: List[str] = []
        # Psychology, Move/Barrier, Time, Heavyweight, News, Experience, Self Review, and Promotion Board remain observation-only branches
        ...
        # Psychology, Time, Move Remaining, Heavyweight, News, Experience, Self Review, and Promotion Board are evidence-only. CO records and
